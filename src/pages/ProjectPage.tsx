...
const ProjectPage: React.FC<ProjectPageProps> = ({
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      {/* Header */}
      <header className="min-h-16 bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-5">
          ...
          <h1 className="text-xl font-semibold text-slate-900">{projectTitle}</h1>
          <span className="text-sm text-slate-500">{projectDate}</span>
        </div>
        <div className="flex gap-3">
          <button className="px-4 py-2 border border-slate-200 bg-white rounded-md text-sm hover:bg-slate-50 transition-all flex items-center gap-2">
          ...
          <button
            ...
            className={`px-4 py-2 border border-slate-200 bg-white rounded-md text-sm hover:bg-slate-50 transition-all flex items-center gap-2 ${
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-slate-50">
        ...
        <div className="bg-white border-b border-slate-200 px-6 py-5">
          <textarea
            ...
            className="w-full px-4 py-3 border border-slate-200 rounded-lg text-sm resize-none outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all"
            rows={1}
            ...
            <div key={message.id} className="mb-6">
              ...
              <div className="pl-10">
                ...
                {message.type === 'question' && message.options && (
                  <div>
                    <p className="text-sm font-medium text-slate-900 mt-2 mb-3">
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-full border-2 text-sm font-medium transition-all flex items-center gap-2 ${
                            message.selectedOptions?.includes(option)
                              ...
                              : 'bg-white text-slate-700 border-slate-200 hover:border-blue-600 hover:bg-blue-50'
                          }`}
                        >
        ...
        <div className="bg-white border-t border-slate-200 px-6 py-5 shadow-lg">
          <div className="max-w-2xl mx-auto flex items-center gap-4 px-4 py-4 bg-blue-50 border border-blue-300 rounded-lg">
            ...
            <div className="flex-1">
              <div className="text-sm font-semibold text-slate-900 mb-0.5">Set up your sandbox</div>
              <div className="text-xs text-slate-600">Connect to your development environment to start building</div>
            </div>
