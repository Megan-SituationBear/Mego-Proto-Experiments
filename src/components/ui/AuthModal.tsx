          ...
          {step === 'sso' ? (
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  onClick={() => setStep('sso')}
                  disabled={isLoading}
                  className="flex-1 px-6 py-2.5 rounded border border-[#62748e] bg-white text-[#020618] text-sm sm:text-[15px] font-roboto font-medium hover:bg-slate-50 transition-colors disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={isLoading}
                  className="flex-1 px-6 py-2.5 bg-blue-600 text-white rounded text-sm sm:text-[15px] font-roboto font-medium shadow-sm hover:bg-indigo-600 hover:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                >
            ...
            <form onSubmit={mode === 'signin' ? handleEmailSignIn : handleEmailSignUp} className="flex flex-col gap-4 sm:gap-5">
              ...
              <button
                ...
                className="w-full px-6 sm:px-8 py-2 bg-blue-600 text-white rounded text-sm sm:text-[15px] font-roboto font-medium shadow-sm hover:bg-indigo-600 hover:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
